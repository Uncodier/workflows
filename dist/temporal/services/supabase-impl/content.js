...
exports.fetchDraftContent = fetchDraftContent;
exports.fetchSiteAnalysis = fetchSiteAnalysis;
exports.hasSiteAnalysis = hasSiteAnalysis;
async function fetchDraftContent(client, siteId) {
...
async function fetchSiteAnalysis(client, siteId) {
...
async function hasSiteAnalysis(client, siteId) {
    try {
