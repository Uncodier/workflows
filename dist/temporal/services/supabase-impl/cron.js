...
exports.fetchCronStatus = fetchCronStatus;
exports.upsertCronStatus = upsertCronStatus;
exports.batchUpsertCronStatus = batchUpsertCronStatus;
exports.fetchStuckCronStatus = fetchStuckCronStatus;
exports.fetchAllRunningCronStatus = fetchAllRunningCronStatus;
exports.resetCronStatusToFailed = resetCronStatusToFailed;
exports.fetchRecentCronStatus = fetchRecentCronStatus;
async function fetchCronStatus(client, activityName, siteIds) {
...
async function upsertCronStatus(client, cronStatusRecord) {
...
async function batchUpsertCronStatus(client, records) {
...
async function fetchStuckCronStatus(client, hoursThreshold = 2) {
...
async function fetchAllRunningCronStatus(client) {
...
async function resetCronStatusToFailed(client, recordId, errorMessage) {
...
async function fetchRecentCronStatus(client, limit = 10) {
