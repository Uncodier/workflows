...
exports.fetchActiveBillings = fetchActiveBillings;
exports.updateSiteCredits = updateSiteCredits;
exports.fetchBillingForSite = fetchBillingForSite;
exports.fetchSitesWithoutBilling = fetchSitesWithoutBilling;
exports.createBillingRecord = createBillingRecord;
async function fetchActiveBillings(client) {
...
async function updateSiteCredits(client, siteId, credits) {
...
async function fetchBillingForSite(client, siteId) {
    const { data, error } = await client
        .from('billing')
        .select('*')
        .eq('site_id', siteId)
...
async function fetchSitesWithoutBilling(client) {
...
async function createBillingRecord(client, billingData) {
