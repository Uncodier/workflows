...
exports.RETRY_POLICIES = exports.WORKFLOW_TIMEOUTS = exports.ACTIVITY_TIMEOUTS = void 0;
exports.getActivityProxy = getActivityProxy;
exports.ACTIVITY_TIMEOUTS = {
 ...
 */
function getActivityProxy(activities, timeoutType = 'DEFAULT', retryType = 'DEFAULT') {
    return {
        startToCloseTimeout: exports.ACTIVITY_TIMEOUTS[timeoutType],
        retry: exports.RETRY_POLICIES[retryType],
    };
}
