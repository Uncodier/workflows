...
exports.extractSearchAttributesFromInput = extractSearchAttributesFromInput;
exports.mergeSearchAttributes = mergeSearchAttributes;
exports.validateSearchAttributes = validateSearchAttributes;
exports.addWorkflowCategory = addWorkflowCategory;
/**
 ...
 */
function extractSearchAttributesFromInput(input) {
 ...
 */
function mergeSearchAttributes(...attributes) {
    const merged = {};
 ...
 */
function validateSearchAttributes(attributes) {
 ...
 */
function addWorkflowCategory(attributes, category) {
    return {
        ...attributes,
