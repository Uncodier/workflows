...
const { logWorkflowExecutionActivity, saveCronStatusActivity, getSiteActivity, deepResearchActivity, searchOperationActivity, dataAnalysisActivity, } = (0, workflow_1.proxyActivities)({
    ...
    try {
        ...
        if (operations.length > 0) {
            ...
            for (let i = 0; i < operations.length; i++) {
                ...
                try {
                    // Pass the complete operation structure as the user requested
                    const searchRequest = {
