...
exports.dailyCreditRenewalWorkflow = dailyCreditRenewalWorkflow;
const workflow_1 = require("@temporalio/workflow");
const { fetchSitesDueForCreditRenewalActivity, renewSiteCreditsActivity, fetchSitesNeedingInitializationActivity, initializeSiteCreditsActivity } = (0, workflow_1.proxyActivities)({
    startToCloseTimeout: '5m',
});
async function dailyCreditRenewalWorkflow() {
