...
exports.sendApprovedMessagesWorkflow = sendApprovedMessagesWorkflow;
...
const { getApprovedMessagesActivity, markMessageAsSendingActivity, resetStuckSendingMessagesActivity, sendEmailFromAgentActivity, updateMessageStatusToSentActivity, updateMessageTimestampActivity, updateConversationStatusAfterFollowUpActivity, updateTaskStatusToCompletedActivity, cleanupFailedFollowUpActivity } = (0, workflow_1.proxyActivities)({
    startToCloseTimeout: '5 minutes',
    retry: {
        maximumAttempts: 3,
    },
});
async function sendApprovedMessagesWorkflow() {
    ...
    async function processOneMessage(msg) {
        ...
        try {
            if (channel === 'email') {
                ...
                await (0, workflow_1.startChild)(sendChannelMessageFromAgentWorkflow_1.sendChannelMessageFromAgentWorkflow, {
                ...
                await (0, workflow_1.startChild)(sendWhatsappFromAgentWorkflow_1.sendWhatsappFromAgent, {
            ...
            if (!sent) {
                ...
                try {
                    ...
                    if (channel === 'email') {
                        ...
                        if (subject)
                            delivery_details.subject = subject;
                    }
