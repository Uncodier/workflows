...
exports.getApprovedMessagesActivity = getApprovedMessagesActivity;
exports.markMessageAsSendingActivity = markMessageAsSendingActivity;
exports.resetStuckSendingMessagesActivity = resetStuckSendingMessagesActivity;
const supabaseService_1 = require("../services/supabaseService");
async function getApprovedMessagesActivity() {
        ...
        try {
            ...
            if (conversations) {
                for (const c of conversations) {
                    const channel = c.channel || c.custom_data?.channel || null;
 ...
 */
async function markMessageAsSendingActivity(request) {
    ...
    const updated = { ...customData, status: 'sending' };
 ...
 */
async function resetStuckSendingMessagesActivity() {
    ...
    for (const row of stuck) {
        const customData = row.custom_data || {};
        const updated = { ...customData, status: 'accepted' };
