 ...
 */
function createFallbackOperations(request) {
 ...
 */
function createFallbackSearchResults(request) {
 ...
 */
function createFallbackAnalysis(request) {
 ...
 */
function createFallbackSegmentation(request) {
