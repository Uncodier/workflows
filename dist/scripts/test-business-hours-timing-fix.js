...
exports.testBusinessHoursTimingFix = testBusinessHoursTimingFix;
...
async function testBusinessHoursTimingFix() {
    ...
    try {
        ...
        const analysis1 = await (0, prioritizationActivities_1.evaluateBusinessHoursForDay)(1); // Monday
        console.log('\n📊 Analysis Results:');
        ...
        const analysis2 = await (0, prioritizationActivities_1.evaluateBusinessHoursForDay)(1); // Monday
        console.log('\n📊 Analysis Results:');
        ...
        const analysis3 = await (0, prioritizationActivities_1.evaluateBusinessHoursForDay)(0); // Sunday
        console.log('\n📊 Analysis Results:');
        ...
        const analysis4 = await (0, prioritizationActivities_1.evaluateBusinessHoursForDay)(1); // Monday
        console.log('\n📊 Analysis Results:');
