...
const leadAttentionWorkflow_1 = require("../temporal/workflows/leadAttentionWorkflow");
async function main() {
    ...
    for (const testCase of testCases) {
        ...
        try {
            ...
            const handle = await client.workflow.start(leadAttentionWorkflow_1.leadAttentionWorkflow, {
                workflowId,
                taskQueue: 'default',
                args: [{
