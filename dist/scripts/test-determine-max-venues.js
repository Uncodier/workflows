...
exports.testDetermineMaxVenues = testDetermineMaxVenues;
exports.testMultipleScenarios = testMultipleScenarios;
...
async function testDetermineMaxVenues() {
    ...
    try {
        ...
        const result = await (0, leadGenerationActivities_1.determineMaxVenuesActivity)({
