...
exports.testCleanupConversationDeletion = testCleanupConversationDeletion;
...
async function testCleanupConversationDeletion() {
    ...
    try {
        const result1 = await (0, leadActivities_1.cleanupFailedFollowUpActivity)({
            lead_id: 'test-lead-1',
            site_id: 'test-site-1',
    ...
    try {
        const result2 = await (0, leadActivities_1.cleanupFailedFollowUpActivity)({
            lead_id: 'test-lead-2',
            site_id: 'test-site-2',
