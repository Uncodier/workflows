...
exports.testSingleSiteSetup = testSingleSiteSetup;
exports.testMinimalSiteSetup = testMinimalSiteSetup;
exports.testSiteSetupValidation = testSiteSetupValidation;
exports.testMultipleSiteSetups = testMultipleSiteSetups;
const client_1 = require("../temporal/client");
// Sample site setup data for testing
const testSiteSetupData = [
    {
 ...
 */
async function testSingleSiteSetup() {
    try {
 ...
 */
async function testMinimalSiteSetup() {
    try {
 ...
 */
async function testSiteSetupValidation() {
    try {
 ...
 */
async function testMultipleSiteSetups() {
    try {
