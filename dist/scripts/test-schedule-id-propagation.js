...
exports.testScheduleIdPropagation = testScheduleIdPropagation;
const client_1 = require("../temporal/client");
const leadResearchWorkflow_1 = require("../temporal/workflows/leadResearchWorkflow");
...
async function testScheduleIdPropagation() {
    ...
    try {
        ...
        try {
            const leadResearchHandle = await client.workflow.start(leadResearchWorkflow_1.leadResearchWorkflow, {
        ...
        try {
            const analyzeSiteHandle = await client.workflow.start(analyzeSiteWorkflow_1.analyzeSiteWorkflow, {
