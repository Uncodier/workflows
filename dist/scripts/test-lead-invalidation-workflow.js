...
exports.testSingleLeadInvalidation = testSingleLeadInvalidation;
exports.testMultipleLeadInvalidationScenarios = testMultipleLeadInvalidationScenarios;
exports.testLeadInvalidationWithValidation = testLeadInvalidationWithValidation;
const client_1 = require("../temporal/client");
// Test data for lead invalidation scenarios
const testInvalidationScenarios = [
    {
 ...
 */
async function testSingleLeadInvalidation() {
    try {
 ...
 */
async function testMultipleLeadInvalidationScenarios() {
    try {
 ...
 */
async function testLeadInvalidationWithValidation() {
    try {
