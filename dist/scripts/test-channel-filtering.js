...
const dailyProspectionWorkflow_1 = require("../temporal/workflows/dailyProspectionWorkflow");
    ...
    try {
        ...
        for (const testCase of testCases) {
            ...
            try {
                ...
                const result = await client.workflow.execute(dailyProspectionWorkflow_1.dailyProspectionWorkflow, {
                    workflowId,
