...
exports.testLeadInvalidationDebug = testLeadInvalidationDebug;
...
async function testLeadInvalidationDebug() {
    ...
    try {
        ...
        const handle = await client.workflow.start(leadInvalidationWorkflow_1.leadInvalidationWorkflow, {
 ...
 */
async function checkLeadState(leadId, stage) {
    try {
