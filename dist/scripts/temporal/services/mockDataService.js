...
class MockDataService {
     ...
     */
    static generateMockCronStatuses() {
        return [
            {
                id: 'cron-1',
                site_id: 'site-1',
     ...
     */
    static generateMockSite(overrides = {}) {
        const defaultSite = {
            id: `site-${Date.now()}`,
            name: 'Test Site',
     ...
     */
    static generateMockCronStatus(overrides = {}) {
        const defaultCronStatus = {
            id: `cron-${Date.now()}`,
            site_id: 'test-site',
