...
const leadQualificationWorkflow_1 = require("../temporal/workflows/leadQualificationWorkflow");
...
async function testLeadQualificationWorkflow() {
    ...
    try {
        ...
        const handle = await client.workflow.start(leadQualificationWorkflow_1.leadQualificationWorkflow, {
