...
for deploy in temporal-worker-default temporal-worker-critical temporal-worker-high temporal-worker-low temporal-worker-background temporal-worker-validation temporal-worker-database-maintenance; do
...
log "AKS workers deployed (queues: default, critical-priority, high, low-priority, background-priority, validation, database-maintenance)."
