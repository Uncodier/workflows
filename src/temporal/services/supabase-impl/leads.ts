...
export async function fetchLead(client: SupabaseClient, leadId: string): Promise<any> {
...
export async function updateLead(client: SupabaseClient, leadId: string, updateData: any): Promise<any> {
...
export async function fetchLeadsBySegmentsAndStatus(
