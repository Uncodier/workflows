...
import { sendCustomerSupportMessageActivity } from '../temporal/activities/customerSupportActivities';
...
async function testAgentIdBehavior() {
  ...
  try {
    ...
    const result1 = await sendCustomerSupportMessageActivity(
      testMessageData,
      {
  ...
  try {
    ...
    const result2 = await sendCustomerSupportMessageActivity(
      testMessageData,
      {
  ...
  try {
    ...
    const result3 = await sendCustomerSupportMessageActivity(
      testMessageData,
      {
