...
import { scheduleIndividualLeadGenerationActivity } from '../temporal/activities/workflowSchedulingActivities';
...
async function testStrategicAccountsScheduling() {
  ...
  try {
    ...
    const result = await scheduleIndividualLeadGenerationActivity(mockBusinessHoursAnalysis, options);
...
export { testStrategicAccountsScheduling };