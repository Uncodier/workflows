...
import type { SendWhatsAppFromAgentParams } from '../temporal/workflows/sendWhatsappFromAgentWorkflow';

// Sample WhatsApp message data for testing
const testWhatsAppData: SendWhatsAppFromAgentParams[] = [
  {
 ...
 */
export async function testSingleWhatsAppMessage() {
  try {
 ...
 */
export async function testMinimalWhatsAppMessage() {
  try {
    console.log('📱 Testing Minimal WhatsApp Message...');
    
    const client = await getTemporalClient();
    
    const minimalMessage: SendWhatsAppFromAgentParams = {
 ...
 */
export async function testWhatsAppValidation() {
  try {
 ...
 */
export async function testBatchWhatsAppMessages() {
  try {
