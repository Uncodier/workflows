...
interface MockBusinessHoursAnalysis {
...
function mockEvaluateBusinessHoursForDay(): MockBusinessHoursAnalysis {
...
function calculateSchedulingLogic(
...
export { testSchedulingScenarios, calculateSchedulingLogic }; 