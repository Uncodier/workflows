...
import { leadFollowUpWorkflow, type LeadFollowUpOptions } from '../temporal/workflows/leadFollowUpWorkflow';
...
async function testPhoneFormattingAndInvalidation() {
  ...
  if (process.env.TEMPORAL_ADDRESS) {
    ...
    try {
      ...
      const testOptions: LeadFollowUpOptions = {
...
export { testPhoneFormattingAndInvalidation }; 