...
import { updateTaskStatusToCompletedActivity } from '../temporal/activities/leadActivities';
...
async function testTaskCompletion() {
  ...
  const testData = {
    ...
    stage: 'awareness' as const, // First contact tasks are typically in awareness stage
  ...
  try {
    ...
    const result = await updateTaskStatusToCompletedActivity(testData);
...
export { testTaskCompletion, testWorkflowIntegration, verifyTaskStates }; 